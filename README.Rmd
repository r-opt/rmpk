...
Happy to receive feedback! Also your opinion on merging it with `ompr` and thus breaking old code or creating a new package.
...
* 🚧 LaRow generation through solver callbacks (e.g. for models with exponential many constraints) 🚧 Supply initial feasible solutions
