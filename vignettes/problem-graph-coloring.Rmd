...
model$add_variable(x[i, k], type = "binary", i = 1:n, k = 1:max_colors)
...
model$add_constraint(x[1, 1] == 1)
model$add_constraint(x[2, 2] == 1)
model$add_constraint(x[3, 3] == 1)
model$add_constraint(x[4, 4] == 1)
```
