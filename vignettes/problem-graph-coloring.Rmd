...
model <- MIPModel(ROI_optimizer("glpk", control = list(presolve = TRUE, verbose = TRUE)))
  
# 1 iff node i has color k
x <- model$add_variable("x", type = "integer", i = 1:n, k = 1:max_colors, lb = 0, ub = 1)
  
# 1 iff color k is used
y <- model$add_variable("y", type = "binary", k = 1:max_colors)
